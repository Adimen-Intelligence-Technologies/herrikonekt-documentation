...
Esta sección describe **qué hay en cada pantalla** de la app. Es una referencia complementaria a *Funcionalidades*: aquí el eje es la pantalla, no el caso de uso.
